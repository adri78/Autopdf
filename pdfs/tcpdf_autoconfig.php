...
PDF_HEADER_STRING => texto al lado del logo 
"por Álvaro Felipe - http://escuela.digital/edgrid\ncontacto@escuela.digital");
*/
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'edlogo.png')) {
		$tcpdf_header_logo = 'edlogo.png';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'ED Grid');
}
